...
fix_bad_csv("data/id_all_property.csv", "id_all_property.csv.gz", 2) # 3rd column
fix_bad_csv("data/id_all_ip.csv", "id_all_ip.csv.gz", 2) # 3rd column
fix_bad_csv("data/property_category.csv", "property_category_corrected.csv.gz", 1) # 2nd column
